  ...
  return (
    <section className={`${"mainContent"} ${classes.reviewWrapper}`}>
      ...
      <div className={classes.btnArea}>
        <Link to="https://blog.naver.com/globalsoftwarecampus" target="_blank" className="bigfont1 bold">교육 후기 바로가기</Link>
        <Link to="/service-educases" className="bigfont1 bold">고객 사례 바로가기</Link>
      </div>
    </section>
  );
};
